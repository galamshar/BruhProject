    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.BooleanField(default=False, verbose_name='Portfolio template')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Portfolio owner')),
            ],
        ),
        migrations.CreateModel(
            name='Friendship',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('home_name', models.CharField(max_length=50, verbose_name='Host team name')),
                ('away_name', models.CharField(max_length=50, verbose_name='Name of the guest team')),
                ('home_odd', models.FloatField(default=1.0, validators=[django.core.validators.MinValueValidator(1.0, 'The minimum Odd is 1.0.')], verbose_name='Odd to win the hosts')),
                ...
                ('away_odd', models.FloatField(default=1.0, validators=[django.core.validators.MinValueValidator(1.0, 'The minimum Odd is 1.0.')], verbose_name='Odds to win guests')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chosen_result', models.IntegerField(choices=[(0, 'X'), (1, '1'), (2, '2')], verbose_name='Typical result')),
                ('value', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0, 'The value of the bet must not be negative!')], verbose_name='Bet rate')),
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.event', verbose_name='Typical event')),
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.wallet', verbose_name='Portfolio')),
            ],
        ),
    ]
